...
class RedDeAgua:
    ...
    def verificar_y_distribuir_flujo(self, nodo_origen, nodo_destino, capacidad_flujo):
        ...
        if flujo_disponible >= demanda:
            ...
            sugerencia = f"Se recomienda agregar un tanque o hacer una conexion a una casa para ser conectado a {nodo_destino}."
    ...
    def proponer_nuevos_tanques(self, grupos_casas):
        ...
        for grupo in grupos_casas:
            if grupo:
                ...
                sugerencias_tanques.append(f"Instalar un nuevo tanque en {tanque_sugerido}, o conecte a otra casa, para abastecer a las casas: {', '.join(grupo)}")
